...
const TimelineItem = ({ year, title, description, icon, delay }: TimelineItemProps) => (
  <AnimatedCard delay={delay} className="min-w-[280px] md:min-w-[320px] flex-shrink-0">
    <div className="bg-white rounded-xl shadow-md p-6 h-full border-l-4 border-primary-500">
      <div className="h-12 w-12 rounded-full bg-primary-50 flex items-center justify-center mb-4 text-primary-600">
        {icon}
      </div>
...
const Journey = () => {
  return (
    <section id="our-journey" className="py-16 bg-white">
